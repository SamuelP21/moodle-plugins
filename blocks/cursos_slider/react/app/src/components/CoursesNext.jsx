...
const CoursesNext = ({ courses }) => {
  ...
  return (
    <div ref={containerRef}>
      <div className="course__header" id="headingThree" aria-expanded={!isCollapsed}>
        <h2 className="mb-0 carousel__title">
          <button
            className={`text-left course__button ${isCollapsed ? 'collapsed' : ''}`}
            type="button"
