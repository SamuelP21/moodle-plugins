...
const CoursesEndedEmpty = ({ image_path }) => {
  ...
  return (
    <>
      <div className="course__header" id="headingTwo" aria-expanded="true">
        <h2 className="mb-0 carousel__title">
          <button className="text-left course__button" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            CURSOS TERMINADOS
      ...
      <div id="collapseTwo" className="accordion-collapse collapse show" aria-labelledby="headingTwo">
        <div className="card w-100 d-block coursesEmpty">
          <img 
            src={`${image_path}/Diploma.png`}
            className="coursesEmpty__image" 
            alt="Diploma"
          />
          <div className="card-body coursesEmpty__message">
            <h3 className="card-titles">
              ¡Ya queda menos! Al finalizar el curso, recibirás un diploma que certificará tus conocimientos.
            </h3>
          </div>
        </div>
      </div>
...
export default CoursesEndedEmpty;
